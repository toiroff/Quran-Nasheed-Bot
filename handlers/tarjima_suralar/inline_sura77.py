...
@dp.callback_query_handler(text='sura77')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Mursalot Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Mursalot.docx')
