...
@dp.callback_query_handler(text='sura47')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Muhammad Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Muhammad.docx')
