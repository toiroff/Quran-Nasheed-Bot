...
@dp.callback_query_handler(text='sura60')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Mumtahana Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Mumtahana.docx')
