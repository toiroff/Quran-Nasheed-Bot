...
@dp.callback_query_handler(text='sura41')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Fussilat Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Fussilat.docx')
