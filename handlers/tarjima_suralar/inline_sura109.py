...
@dp.callback_query_handler(text='sura109')
async def suralar(message:CallbackQuery):


     await message.message.answer(text="Kofirun🌹 va Nasr Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Kofirun.docx')
     dokument_manzil2=InputFile(path_or_bytesio='for_send/Nasr.docx')
