...
@dp.callback_query_handler(text='sura83')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Mutaffifin Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Mutaffifin.docx')
