...
@dp.callback_query_handler(text='sura84')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Inshiqoq Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Inshiqoq.docx')
