...
@dp.callback_query_handler(text='sura58')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Mujodala Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Mujodala.docx')
