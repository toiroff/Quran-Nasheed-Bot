...
@dp.callback_query_handler(text='sura73')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Muzammil Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Muzammil.docx')
