...
@dp.callback_query_handler(text='sura63')
async def suralar(message:CallbackQuery):
    await message.message.answer(text="Munofiqun Surasi🌹")
    dokument_manzil = InputFile(path_or_bytesio='for_send/Munofiqun.docx')
