...
@dp.callback_query_handler(text='sura64')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Tag'obun Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio="for_send/Tag'obun.docx")
