...
@dp.callback_query_handler(text='sura74')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="Mudassir Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio='for_send/Mudassir.docx')
