...
@dp.callback_query_handler(text='sura88')
async def suralar(message:CallbackQuery):
     await message.message.answer(text="G'oshiya Surasi🌹")
     dokument_manzil = InputFile(path_or_bytesio="for_send/G'oshiya.docx")
